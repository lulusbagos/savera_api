...
public static class UploadSchemaBootstrap
{
    public static async Task EnsureAsync(NpgsqlDataSource dataSource, ILogger logger, CancellationToken cancellationToken = default)
    {
...
",
        ...
        logger.LogInformation("Upload schema bootstrap ensured.");
    }
}
