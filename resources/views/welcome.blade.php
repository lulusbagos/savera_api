...
<head>
    ...
    <style>
        :root {
            ...
            --panel-hover:   rgba(0,30,70,0.8);
            --outline:       rgba(0,200,255,0.12);
            --outline-strong:rgba(0,200,255,0.28);
            --muted:         #4a7090;
            --text:          #d0eeff;
            --text-dim:      #8ab8d8;
            --cyan:   #00d4ff;
            ...
            --glow-blue:   rgba(61,127,255,0.18);
            --glow-purple: rgba(176,96,255,0.18);
            --glow-green:  rgba(0,255,170,0.18);
            --glow-amber:  rgba(255,184,0,0.18);
            --glow-red:    rgba(255,60,90,0.18);
            --radius-sm: 8px;
            --radius-md: 12px;
            --radius-lg: 16px;
        }
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            background: var(--bg);
            background-image:
                radial-gradient(ellipse 100% 60% at 20% -10%, rgba(0,120,255,0.12) 0%, transparent 60%),
                radial-gradient(ellipse 70% 50% at 80% 5%, rgba(176,96,255,0.10) 0%, transparent 55%),
                radial-gradient(ellipse 60% 80% at 50% 110%, rgba(0,212,255,0.08) 0%, transparent 60%);
            color: var(--text);
        ...
        .nav-logo {
            ...
            box-shadow: 0 0 20px rgba(0,212,255,0.45), 0 0 40px rgba(0,212,255,0.15);
        }
        .nav-logo svg { width: 18px; height: 18px; stroke: #fff; stroke-width: 2; }
        .nav-title { font-weight: 700; font-size: 14px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--cyan); text-shadow: 0 0 12px rgba(0,212,255,0.6); }
        ...
        @keyframes pulse-dot {
            0%,100% { opacity: 0.5; box-shadow: 0 0 4px var(--green); transform: scale(0.9); }
            50%      { opacity: 1;   box-shadow: 0 0 10px var(--green); transform: scale(1.2); }
        }
        .nav-btn {
        ...
        .section-label .sl-icon { width: 5px; height: 5px; background: var(--cyan); border-radius: 50%; box-shadow: 0 0 8px var(--cyan); flex-shrink: 0; }
        ...
        .card-cyan   { box-shadow: 0 0 40px rgba(0,212,255,0.07); }
        .card-cyan:hover { box-shadow: 0 0 60px rgba(0,212,255,0.12); }
        .card-purple { box-shadow: 0 0 40px rgba(176,96,255,0.07); }
        .card-purple:hover { box-shadow: 0 0 60px rgba(176,96,255,0.13); }
        .card-green  { box-shadow: 0 0 40px rgba(0,255,170,0.07); }
        .card-green:hover { box-shadow: 0 0 60px rgba(0,255,170,0.12); }
        .card-amber  { box-shadow: 0 0 40px rgba(255,184,0,0.07); }
        .card-amber:hover { box-shadow: 0 0 60px rgba(255,184,0,0.12); }
        .card-red    { box-shadow: 0 0 40px rgba(255,60,90,0.07); }
        .card-red:hover { box-shadow: 0 0 60px rgba(255,60,90,0.12); }
        ...
        .stat-icon.cyan   { background: var(--glow-cyan);   color: var(--cyan);   box-shadow: 0 0 16px var(--glow-cyan); }
        .stat-icon.purple { background: var(--glow-purple); color: var(--purple); box-shadow: 0 0 16px var(--glow-purple); }
        .stat-icon.green  { background: var(--glow-green);  color: var(--green);  box-shadow: 0 0 16px var(--glow-green); }
        .stat-icon.amber  { background: var(--glow-amber);  color: var(--amber);  box-shadow: 0 0 16px var(--glow-amber); }
        .stat-icon.red    { background: var(--glow-red);    color: var(--red);    box-shadow: 0 0 16px var(--glow-red); }
        .stat-icon.blue   { background: var(--glow-blue);   color: var(--blue);   box-shadow: 0 0 16px var(--glow-blue); }
        ...
        .stat-value.glow-cyan   { color: var(--cyan);   text-shadow: 0 0 20px rgba(0,212,255,0.5); }
        .stat-value.glow-green  { color: var(--green);  text-shadow: 0 0 20px rgba(0,255,170,0.5); }
        .stat-value.glow-red    { color: var(--red);    text-shadow: 0 0 20px rgba(255,60,90,0.5); }
        .stat-value.glow-amber  { color: var(--amber);  text-shadow: 0 0 20px rgba(255,184,0,0.5); }
        .stat-value.glow-purple { color: var(--purple); text-shadow: 0 0 20px rgba(176,96,255,0.5); }
        ...
        .infra-dot { width: 9px; height: 9px; border-radius: 50%; background: var(--green); flex-shrink: 0; box-shadow: 0 0 8px var(--green); animation: pulse-dot 2s ease-in-out infinite; }
        .infra-dot.warn { background: var(--amber); box-shadow: 0 0 8px var(--amber); }
        .infra-dot.bad  { background: var(--red);   box-shadow: 0 0 8px var(--red); }
        ...
        .infra-value { font-size: 22px; font-weight: 700; color: var(--cyan); letter-spacing: -0.5px; font-family: 'JetBrains Mono', monospace; text-shadow: 0 0 14px rgba(0,212,255,0.4); }
        ...
        .infra-bar-fill.cyan   { background: linear-gradient(90deg, var(--cyan), var(--blue)); box-shadow: 0 0 8px var(--cyan); }
        .infra-bar-fill.green  { background: linear-gradient(90deg, var(--green), var(--teal)); box-shadow: 0 0 8px var(--green); }
        .infra-bar-fill.amber  { background: linear-gradient(90deg, var(--amber), #ff8c00); box-shadow: 0 0 8px var(--amber); }
        .infra-bar-fill.purple { background: linear-gradient(90deg, var(--purple), var(--pink)); box-shadow: 0 0 8px var(--purple); }
...
<body>
    ...
    <div class="shell">
        ...
        <div class="page-header">
            ...
            <div class="meta-strip">
                ...
                <span class="badge"><i data-lucide="refresh-cw" style="width:11px;height:11px;vertical-align:middle"></i>&nbsp;Auto 15s</span>
            </div>
        </div>
        ...
        <div class="card card-cyan">
            ...
            <div class="table-scroll table-wrap" style="margin-top:14px">
                <table>
                    <thead><tr>
                        <th style="width:18%">MAC / IP</th><th style="width:8%">User ID</th>
                        <th style="width:14%">Terakhir Aktif</th><th style="width:14%">Menu Terakhir</th>
                        <th style="width:8%">Method</th><th style="width:8%">Status</th>
                        <th style="width:9%">Durasi</th><th style="width:7%">Req</th>
                        <th style="width:7%">Error</th><th>Riwayat Menu</th>
                    </tr></thead>
                    <tbody id="user-activity-body">
                        <tr><td colspan="10" class="empty">Initializing device monitor...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="grid grid-2">
            <div class="card chart-card card-cyan">
                <div class="card-head">
                    ...
                    <span class="pill-outline">30 req</span>
                </div>
    ...
    <script>
        ...
        function renderMeta(meta) {
            ...
            if (logFileEl) logFileEl.textContent = logPath !== '–' ? '&#128196; ' + logPath.split(/[/\\]/).pop() : '&#128196; Log –';
        ...
        function renderChart(entries) {
            ...
            if (!state.chart) {
                state.chart = new Chart(ctx, { type:'line', data:{ labels, datasets:[{ label:'Duration (ms)', data:durations, fill:true, tension:0.4, backgroundColor:grad, borderColor:'rgba(0,212,255,0.9)', borderWidth:2, pointRadius:3, pointBackgroundColor:'rgba(0,212,255,1)', pointHoverRadius:6 }] }, options:chartOptions() });
            } else { state.chart.data.labels = labels; state.chart.data.datasets[0].data = durations; state.chart.update('none'); }
        ...
        function renderStorageChart(durations) {
            ...
            if (!state.storageChart) {
                ...
                state.storageChart.update('none');
            }
        ...
        function chartOptions() {
            return { responsive:true, maintainAspectRatio:false, animation:{duration:400},
                ...
                plugins:{ legend:{labels:{color:'#8ab8d8',font:{family:"'Poppins',sans-serif",size:11}}}, tooltip:{backgroundColor:'rgba(4,15,32,0.95)',borderColor:'rgba(0,212,255,0.3)',borderWidth:1,titleColor:'#00d4ff',bodyColor:'#8ab8d8', callbacks:{label:function(ctx){ return ' '+ctx.parsed.y.toFixed(1)+' ms'; }}} }
            };
        }
        ...
        function renderUsers(data) {
            ...
            if (!users.length) { tbody.innerHTML = '<tr><td colspan="10" class="empty">No active devices detected</td></tr>'; return; }
            const statusCls = function(s) { return !s ? '' : s>=500 ? 'status-5xx' : s>=400 ? 'status-4xx' : 'status-2xx'; };
            tbody.innerHTML = users.map(function(u) {
                const mac = u.mac||'–', uid = u.user_id ? '#'+u.user_id : '–';
                ...
                const ms = u.last_ms!=null ? u.last_ms+'ms' : '–';
                const req = u.request_count||0, err = u.error_count||0;
                const routes = (u.routes||[]).join(', ')||'–';
                return '<tr><td class="mono" style="font-size:10px">'+mac+'</td><td class="mono" style="color:var(--cyan)">'+uid+'</td><td class="mono">'+lastSeen+'</td><td><span class="pill-outline" style="font-size:10px">'+lastRoute+'</span></td><td><span class="method-chip '+methCls+'">'+method+'</span></td><td><span class="'+statusCls(u.last_status)+'">'+status+'</span></td><td class="mono" style="font-size:10px">'+ms+'</td><td style="color:var(--cyan);font-weight:700">'+req+'</td><td style="'+(err>0?'color:var(--red);font-weight:700':'')+'">'+err+'</td><td style="font-size:10px;color:var(--muted)">'+routes+'</td></tr>';
            }).join('');
        }
        ...
        function start() {
            ...
            state.userTimer = setInterval(loadUsers, 12000);
            updateFilterLabel();
        }
